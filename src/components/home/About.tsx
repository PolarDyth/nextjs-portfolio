  ...
  return (
    <section id="about" className="flex flex-col gap-12 justify-between text-left items-center md:flex-row">
      <div className="md:w-1/2 relative">
        <Image src="https://kzmqem5a2thfoqjtshg0.lite.vusercontent.net/placeholder.svg" alt="" width="500" height="500" className="rounded-2xl w-full max-w-md m-auto"/>
      ...
      <div className="md:w-1/2 flex flex-col gap-6">
        ...
        <Button asChild className="w-fit group">
          <Link href="/">Download Resume <ArrowRight className="transition-transform group-hover:translate-x-1" /></Link>
        </Button>
      </div>
    </section>
    )
