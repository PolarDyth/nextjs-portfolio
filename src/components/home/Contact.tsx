...
export default function Contact() {
  ...
  return (
    <section id="contact" className="py-20 my-20 text-center">
        ...
        {contactInfo.map((prop, index) => (
          <div key={index}>
            <div className="flex items-center gap-4 text-left">
                <Link href={prop.action ? prop.action + prop.link : prop.link} className="bg-primary/20 p-4 rounded-lg text-primary hover:bg-primary/50 hover:text-foreground transition-colors hover:scale-110 transform duration-200">
                  {prop.icon}                
                </Link>
              <div>
